...
# Logitech Media Server Copyright 2001-2024 Dan Sully, Logitech.
...
Returns the location of Lyrion Music Server's scanner log file.
...
Returns a list of the the locations of Lyrion Music Server's log files.
...
Returns the logging mode of Lyrion Music Server's scanner log file.
...
Returns the location of Lyrion Music Server's performance monitor log file.
...
Returns the logging mode of Lyrion Music Server's performance monitor log file.
...
sub writeConfig {
	...
	print $fh "# If you wish to modify, make a copy and call Lyrion Music Server\n";
